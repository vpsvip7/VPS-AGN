...
dependencias() {
  soft="sudo zip unzip ufw curl python python3  screen cron iptables lsof pv  nano at mlocate gawk grep bc jq curl npm nodejs socat netcat net-tools cowsay figlet lolcat"
